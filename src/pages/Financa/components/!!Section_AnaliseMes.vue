...
<script>
  ...
  import GraficoBarV from '@/components/Grafico/Financa/BarVertica-analisel'
  import TableAnalise from "@/pages/Financa/components/Table_AnaliseMes.vue"
    ...
    methods: {
      getDados() {
        ...
        setTimeout(() => {
          ...
          var endPoint = "";
          endPoint += "analise-ultimos-meses";
